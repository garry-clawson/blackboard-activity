...
function getAnswer() {
  ...
  if(x.value != answer){
        ...
        document.getElementById("congrates").innerHTML = wellDone; //inserts 'text' into the yourscore ID eleme
...
// function getAnswer() {
	  // answer1=document.puzzle1.answer1.value;
	  // var ans == "updates";

  // if(answer1 != ans){
        // document.getElementById('puzzle1').style.backgroundColor = "red"; //when answer is incorrcet turn red
        // return false;
    // }
	// else{
        // document.getElementById('puzzle1').style.backgroundColor = "green"; //when answer is correct turn green
        ...
        // localStorage.setItem("rm1_puzzle2", "complete");
    // };
// }
...
// var answer = SHA1("1"); //asign result of SHA1 function to answer: 8e7bfba9e19799a114779acb186357d7e4535d72
// console.log(answer);
